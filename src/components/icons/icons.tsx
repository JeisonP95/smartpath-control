...
export const Leaf: React.FC<IconProps> = ({ size = 24, className = "" }) => (
  <svg
...
export const Instagram: React.FC<IconProps> = ({ size = 20, className = "" }) => (
  <svg
    ...
    className={className}
  >
    <rect x="2" y="2" width="20" height="20" rx="50" ry="5"></rect>
...
export const ArrowDown: React.FC<IconProps> = ({ size = 24, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Calendar: React.FC<IconProps> = ({ size = 16, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Tag: React.FC<IconProps> = ({ size = 12, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
